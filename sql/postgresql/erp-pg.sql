...
CREATE INDEX idx_finance_payment_no ON erp_finance_payment (no);

-- ============================================
-- 4. erp_finance_payment_item
-- ============================================
DROP TABLE IF EXISTS erp_finance_payment_item;
...
CREATE INDEX idx_finance_payment_item_payment_id ON erp_finance_payment_item (payment_id);
CREATE INDEX idx_finance_payment_item_biz_no ON erp_finance_payment_item (biz_no);
CREATE INDEX idx_finance_payment_item_biz_id_type ON erp_finance_payment_item (biz_id, biz_type);

-- ============================================
-- 5. erp_finance_receipt
-- ============================================
DROP TABLE IF EXISTS erp_finance_receipt;
...
CREATE INDEX idx_finance_receipt_no ON erp_finance_receipt (no);

-- ============================================
-- 6. erp_finance_receipt_item
-- ============================================
DROP TABLE IF EXISTS erp_finance_receipt_item;
...
CREATE INDEX idx_finance_receipt_item_receipt_id ON erp_finance_receipt_item (receipt_id);
CREATE INDEX idx_finance_receipt_item_biz_no ON erp_finance_receipt_item (biz_no);
CREATE INDEX idx_finance_receipt_item_biz_id_type ON erp_finance_receipt_item (biz_id, biz_type);

-- ============================================
-- 7. erp_product_category
-- ============================================
DROP TABLE IF EXISTS erp_product_category;
...
CREATE INDEX idx_product_category_parent_name ON erp_product_category (parent_id, name);
...
CREATE TABLE erp_product (
    ...
    expiry_day INTEGER DEFAULT NULL,
...
CREATE INDEX idx_product_category_id ON erp_product (category_id);
CREATE INDEX idx_product_unit_id ON erp_product (unit_id);

-- ============================================
-- 10. erp_purchase_order
-- ============================================
DROP TABLE IF EXISTS erp_purchase_order;
CREATE TABLE erp_purchase_order (
    ...
    deleted SMALLINT NOT NULL DEFAULT 0,
    tenant_id BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uk_purchase_order_no UNIQUE (no)
);
...
CREATE INDEX idx_purchase_order_no ON erp_purchase_order (no);

-- ============================================
-- 11. erp_purchase_order_items
-- ============================================
DROP TABLE IF EXISTS erp_purchase_order_items;
...
CREATE INDEX idx_purchase_order_items_order_id ON erp_purchase_order_items (order_id);
CREATE INDEX idx_purchase_order_items_product_order ON erp_purchase_order_items (product_id, order_id);
...
CREATE TABLE erp_purchase_in (
    ...
    deleted SMALLINT NOT NULL DEFAULT 0,
    tenant_id BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uk_purchase_in_no UNIQUE (no)
);
...
CREATE INDEX idx_purchase_in_order_id ON erp_purchase_in (order_id);

-- ============================================
-- 13. erp_purchase_in_items
-- ============================================
DROP TABLE IF EXISTS erp_purchase_in_items;
...
CREATE INDEX idx_purchase_in_items_in_order ON erp_purchase_in_items (in_id, order_item_id);
CREATE INDEX idx_purchase_in_items_product_warehouse ON erp_purchase_in_items (product_id, warehouse_id, in_id);

-- ============================================
-- 14. erp_purchase_return
-- ============================================
DROP TABLE IF EXISTS erp_purchase_return;
CREATE TABLE erp_purchase_return (
    ...
    deleted SMALLINT NOT NULL DEFAULT 0,
    tenant_id BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uk_purchase_return_no UNIQUE (no)
);
...
CREATE INDEX idx_purchase_return_order_id ON erp_purchase_return (order_id);

-- ============================================
-- 15. erp_purchase_return_items
-- ============================================
DROP TABLE IF EXISTS erp_purchase_return_items;
...
CREATE INDEX idx_purchase_return_items_return_order ON erp_purchase_return_items (return_id, order_item_id);
CREATE INDEX idx_purchase_return_items_product_warehouse ON erp_purchase_return_items (product_id, warehouse_id, return_id);
...
CREATE TABLE erp_sale_order (
    ...
    order_time TIMESTAMP NOT NULL,
    total_count DECIMAL(24, 6) NOT NULL DEFAULT 0.000000,
    total_price DECIMAL(24, 6) NOT NULL,
    total_product_price DECIMAL(24, 6) NOT NULL,
    total_tax_price DECIMAL(24, 6) NOT NULL,
    discount_percent DECIMAL(24, 6) NOT NULL,
    ...
    deleted SMALLINT NOT NULL DEFAULT 0,
    tenant_id BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uk_sale_order_no UNIQUE (no)
);
...
CREATE INDEX idx_sale_order_no ON erp_sale_order (no);

-- ============================================
-- 17. erp_sale_order_items
-- ============================================
DROP TABLE IF EXISTS erp_sale_order_items;
...
CREATE INDEX idx_sale_order_items_order_id ON erp_sale_order_items (order_id);
CREATE INDEX idx_sale_order_items_product_order ON erp_sale_order_items (product_id, order_id);
...
CREATE TABLE erp_sale_out (
    ...
    deleted SMALLINT NOT NULL DEFAULT 0,
    tenant_id BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uk_sale_out_no UNIQUE (no)
);
...
CREATE INDEX idx_sale_out_order_id ON erp_sale_out (order_id);

-- ============================================
-- 19. erp_sale_out_items
-- ============================================
DROP TABLE IF EXISTS erp_sale_out_items;
...
CREATE INDEX idx_sale_out_items_out_order ON erp_sale_out_items (out_id, order_item_id);
CREATE INDEX idx_sale_out_items_product_warehouse ON erp_sale_out_items (product_id, warehouse_id, out_id);
...
CREATE TABLE erp_sale_return (
    ...
    deleted SMALLINT NOT NULL DEFAULT 0,
    tenant_id BIGINT NOT NULL DEFAULT 0,
    CONSTRAINT uk_sale_return_no UNIQUE (no)
);
...
CREATE INDEX idx_sale_return_order_id ON erp_sale_return (order_id);

-- ============================================
-- 21. erp_sale_return_items
-- ============================================
DROP TABLE IF EXISTS erp_sale_return_items;
...
CREATE INDEX idx_sale_return_items_return_order ON erp_sale_return_items (return_id, order_item_id);
CREATE INDEX idx_sale_return_items_product_warehouse ON erp_sale_return_items (product_id, warehouse_id, return_id);
...
CREATE INDEX idx_stock_product_warehouse ON erp_stock (product_id, warehouse_id);
...
CREATE INDEX idx_stock_check_no ON erp_stock_check (no);

-- ============================================
-- 24. erp_stock_check_item
-- ============================================
DROP TABLE IF EXISTS erp_stock_check_item;
...
CREATE INDEX idx_stock_check_item_check_id ON erp_stock_check_item (check_id);
CREATE INDEX idx_stock_check_item_product_warehouse ON erp_stock_check_item (product_id, warehouse_id, check_id);
...
CREATE INDEX idx_stock_in_no ON erp_stock_in (no);

-- ============================================
-- 26. erp_stock_in_item
-- ============================================
DROP TABLE IF EXISTS erp_stock_in_item;
...
CREATE INDEX idx_stock_in_item_in_id ON erp_stock_in_item (in_id);
CREATE INDEX idx_stock_in_item_product_warehouse ON erp_stock_in_item (product_id, warehouse_id, in_id);
...
CREATE INDEX idx_stock_move_no ON erp_stock_move (no);

-- ============================================
-- 28. erp_stock_move_item
-- ============================================
DROP TABLE IF EXISTS erp_stock_move_item;
...
CREATE INDEX idx_stock_move_item_move_id ON erp_stock_move_item (move_id);
CREATE INDEX idx_stock_move_item_product_from_warehouse ON erp_stock_move_item (product_id, from_warehouse_id, move_id);
...
CREATE INDEX idx_stock_out_no ON erp_stock_out (no);

-- ============================================
-- 30. erp_stock_out_item
-- ============================================
DROP TABLE IF EXISTS erp_stock_out_item;
...
CREATE INDEX idx_stock_out_item_out_id ON erp_stock_out_item (out_id);
CREATE INDEX idx_stock_out_item_product_warehouse ON erp_stock_out_item (product_id, warehouse_id, out_id);
...
CREATE INDEX idx_stock_record_product_warehouse ON erp_stock_record (product_id, warehouse_id);
